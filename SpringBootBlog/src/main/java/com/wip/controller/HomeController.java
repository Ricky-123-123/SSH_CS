...
public class HomeController extends BaseController {
    ...
    @ApiOperation("教程详情")
    @GetMapping(value = "/course_detail/{courseid}")
    public String detailCourse(
        ...
        // 更新教程的点击量
        this.updateCourseHits(course.getCourseid(),course.getHits());
        // 获取评论
        List<CommentDomain> comments = commentService.getCommentsByCId(courseid);
        request.setAttribute("comments", comments);
     ...
     * @param chits
     */
    private void updateCourseHits(Integer courseid, Integer chits) {
        ...
        if (hits >= WebConst.HIT_EXEED) {
            ...
            temp.setHits(chits + hits);
            courseService.updateCourseByCourseid(temp);        
