...
public class CourseController extends BaseController {
    ...
    public String index(
        ...
        PageInfo<CourseDomain> courses = courseService.getCourseyCond(new ContentCond(), page, limit);
...
//        List<MetaDomain> metas = metaService.getMetas(metaCond);
    ...
    public String editArticle(
            @ApiParam(name = "courseid", value = "教程编号", required = true)
            @PathVariable
            Integer courseid,
            HttpServletRequest request
    ) {
    	CourseDomain course =courseService.getCourseById(courseid);        
        request.setAttribute("contents", course);
        MetaCond metaCond = new MetaCond();
        metaCond.setType(Types.CATEGORY.getType());
    ...
    public APIResponse modifyArticle(
    	...
    	courseDomain.setCourseid(courseid);
    ...
    public APIResponse deleteArticle(
            @ApiParam(name = "courseid", value = "教程ID", required = true)
            @RequestParam(name = "courseid", required = true)
            Integer courseid,
            HttpServletRequest request
    ) {
        ...
        // 写入日志
        logService.addLog(LogActions.DEL_ARTICLE.getAction(), courseid+"",request.getRemoteAddr(),this.getUid(request));
        return APIResponse.success();
    }
