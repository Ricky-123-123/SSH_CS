...
public interface ErrorConstant {
    ...
    interface Course {
        static final String UPDATE_COURSE_FAIL = "更新教程失败";
        static final String ADD_NEW_COURSE_FAIL = "添加教程失败";
        static final String DELETE_COURSE_ERROR = "删除教程文章失败";
        static final String TITLE_IS_TOO_LONG = "教程文章标题过长";
